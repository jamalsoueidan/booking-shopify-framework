...
To configure this env for a component (or group of components) via the CLI, run `bit env set "some/*/glob/pattern/**" jamalsoueidan.bsd/react-version-envs/react-18-env`.
...
```json
{
  "teambit.workspace/variants": {
    "{ui/**}, {pages/**}": {
      "jamalsoueidan.bsd/react-version-envs/react-18-env": {}
    }
  }
}
```
...
```bash
bit fork jamalsoueidan.bsd/react-version-envs/react-18-env <your-env-name>
```
