...
import { CustomerModel } from "@jamalsoueidan/backend.services.customer";
import { NotificationModel } from "@jamalsoueidan/backend.services.notification";
import {
  NotificationTemplateServiceGet,
  NotificationTemplateServiceReplace,
} from "@jamalsoueidan/backend.services.notification-template";
import { StaffModel } from "@jamalsoueidan/backend.services.staff";
import {
  Notification,
  NotificationBody,
  NotificationQuery,
} from "@jamalsoueidan/backend.types.notification";
